...
##Login Function - This Function is used for the login
def login():
    try:
...
##Logout Function - Function for logging out of the webpage
def logout():
    try:
        session["email"] = None
...
##Function for ordering new prodicts
def create_order():
    try:
        user_email = session.get("email")
        user_query = f"select * from users where email='{user_email}';"
...
##Function for raising a concern
def submit_help():
...
##Function for searching the order
def search_order():
